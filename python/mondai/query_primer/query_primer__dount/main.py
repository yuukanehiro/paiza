...
def main():
    ...
    for q in queries:
        ...
        outer = calc(sum_matrix, pivotY - outer_radius, pivotX - outer_radius, pivotY + outer_radius, pivotX + outer_radius)
        inner = calc(sum_matrix, pivotY - inner_radius, pivotX - inner_radius, pivotY + inner_radius, pivotX + inner_radius)

        print(outer - inner)


def calc(sum_matrix: List[int], top: int, left: int, bottom: int, right: int) -> int:
